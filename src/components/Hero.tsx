...
export function Hero() {
  return (
    <section id="home" className="min-h-screen flex items-center bg-gradient-to-br from-slate-50 via-white to-blue-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-800">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-slate-900 dark:text-white leading-tight">
                Raghav <span className="text-blue-600 dark:text-blue-400">Dixit</span>
              </h1>
              <div className="text-2xl md:text-3xl text-slate-600 dark:text-slate-300 font-light">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-300 max-w-2xl leading-relaxed">
              ...
              Passionate about creating intuitive user interfaces that make a difference.
            </p>
            
            <div className="flex flex-wrap gap-4">
              <a href="#projects" className="btn btn-accent text-lg px-8 py-4">
                View My Work
              </a>
              <a href="#contact" className="btn text-lg px-8 py-4">
                Get In Touch
              </a>
            </div>
            ...
            <div className="relative w-full max-w-md mx-auto">
              ...
              <div className="relative bg-white dark:bg-slate-800 rounded-3xl p-8 shadow-2xl">
                <div className="flex items-center justify-center mb-6">
                  <img src={profile} alt="Raghav Dixit" className="w-32 h-32 rounded-full object-cover shadow-lg" />
                </div>
                <div className="text-center space-y-2">
                  <h3 className="text-xl font-semibold text-slate-900 dark:text-white">Raghav Dixit</h3>
                  <p className="text-blue-600 dark:text-blue-400 font-medium">Frontend Developer</p>
                  <p className="text-sm text-slate-600 dark:text-slate-300">Greater Noida, India</p>
                </div>
              </div>
            </div>
          </div>
